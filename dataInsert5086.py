...
sql ="CREATE TABLE NCDC_5086 (usWStnID INT, wbanWStnID INT, obsDate DATE," 
...
for line in f:
        ...
        sql= "insert into NCDC_5086 VALUES('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')" %(usWStnID,wbanWStnID,\
