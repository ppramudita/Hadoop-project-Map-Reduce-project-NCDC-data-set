...
sql ="CREATE TABLE NCDC_1950 (usWStnID INT, wbanWStnID INT, obsDate DATE," 
...
for line in f:
        ...
        sql= "insert into NCDC_1950 VALUES('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')" %(usWStnID,wbanWStnID,\
